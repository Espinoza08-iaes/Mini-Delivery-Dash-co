...
CC = gcc
TARGET = main.exe
SRC = src/main.cpp src/game/Game.cpp src/game/City.cpp src/game/city_physics/CityPhysics.cpp src/engine/Mesh.cpp src/engine/Model.cpp src/engine/Texture.cpp
